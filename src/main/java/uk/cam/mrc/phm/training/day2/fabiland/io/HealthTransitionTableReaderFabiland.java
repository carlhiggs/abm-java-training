...
public class HealthTransitionTableReaderFabiland {

    private final static Logger logger = LogManager.getLogger(HealthTransitionTableReaderFabiland.class);
    ...
    public EnumMap<Diseases, Map<String, Double>> readData(DataContainerHealth dataContainer, String path) {
        ...
        try {
            ...
            int posLocation = SiloUtil.findPositionInArray("zoneId", header);
