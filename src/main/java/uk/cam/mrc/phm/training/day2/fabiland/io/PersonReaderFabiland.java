...
public class PersonReaderFabiland implements PersonReader {

    private final static Logger logger = LogManager.getLogger(PersonReaderFabiland.class);
    private final HouseholdDataManager householdDataManager;

    public PersonReaderFabiland(HouseholdDataManager householdDataManager) {
    ...
    public void readData(String path) {
        ...
        PersonFactoryFabiland ppFactory = new PersonFactoryFabiland();
        String recString = "";
        int recCount = 0;
        try {
            ...
            while ((recString = in.readLine()) != null) {
                ...
                PersonHealthFabiland pp = ppFactory.createPerson(id, age, gender, occupation,pr, workplace, income);
