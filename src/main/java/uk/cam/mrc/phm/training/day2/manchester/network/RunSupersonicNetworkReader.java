package uk.cam.mrc.phm.training.day2.manchester.network;
...
public class RunSupersonicNetworkReader {
    ...
    private static final String inputFile = "scenarios/manchester/network/greater-manchester-latest.osm.pbf";
    private static final String outputFile = "scenarios/manchester/network/greater-manchester.xml";
