package uk.cam.mrc.phm.training.day2.manchester.demand;
...
public class GenerateRandomDemand {
	...
	private static final String MSOAs = "scenarios/manchester/zones/Middle_Layer_Super_Output_Areas_December_2011_Boundaries_BFC.shp"; // Polygon shapefile for demand generation
	private static final String CAR_MATRIX = "scenarios/manchester/demand/car_matrix_greater_manchester.csv"; // OD Matrix for cars
	private static final String PLANS_FILE_OUTPUT = "scenarios/manchester/demand/plans.xml"; // The output file of demand generation
