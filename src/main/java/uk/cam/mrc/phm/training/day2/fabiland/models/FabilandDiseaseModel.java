...
public class FabilandDiseaseModel extends AbstractModel implements ModelUpdateListener {
    private static final Logger logger = LogManager.getLogger(DiseaseModelMCR.class);

    public FabilandDiseaseModel(DataContainer dataContainer, Properties properties, Random random) {
